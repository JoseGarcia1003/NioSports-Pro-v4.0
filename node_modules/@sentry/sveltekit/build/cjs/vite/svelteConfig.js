 ...
 */
function getHooksFileName(svelteConfig, hookType) {
 ...
 */
async function getAdapterOutputDir(svelteConfig, adapter) {
  if (adapter === 'node') {
 ...
 */
async function getNodeAdapterOutputDir(svelteConfig) {
...
exports.getAdapterOutputDir = getAdapterOutputDir;
exports.getHooksFileName = getHooksFileName;
exports.loadSvelteConfig = loadSvelteConfig;
//# sourceMappingURL=svelteConfig.js.map
