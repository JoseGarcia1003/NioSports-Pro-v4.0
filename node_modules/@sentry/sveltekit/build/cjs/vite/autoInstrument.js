...
const recastTypescriptParser = require('./recastTypescriptParser.js');
...
async function canWrapLoad(id, debug) {
  ...
  const ast = recast.parse(code, {
    parser: recastTypescriptParser.parser,
  });
