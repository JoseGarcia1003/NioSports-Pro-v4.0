import { uuid4, escapeStringForRegex } from '@sentry/core';
...
import { getAdapterOutputDir } from './svelteConfig.js';
...
;
  ...
  const sentryPlugins = await sentryVitePlugin(mergedOptions);
...
export { _getUpdatedSourceMapSettings, makeCustomSentryVitePlugins };
