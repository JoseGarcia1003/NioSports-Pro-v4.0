...
const instrumentDurableObjectStorage = require('../instrumentations/instrumentDurableObjectStorage.js');
    ...
    descriptors.storage = {
      ...
      get: () => {
        if (!instrumentedStorage) {
          instrumentedStorage = instrumentDurableObjectStorage.instrumentDurableObjectStorage(originalStorage);
        }
...
exports.instrumentContext = instrumentContext;
//# sourceMappingURL=instrumentContext.js.map
