...
6. Versión disponible integrada en `main` el 22 de septiembre por petición explícita del propietario. Completar la validación comercial pendiente; publicar la interfaz no demuestra cobertura deportiva, autenticación externa ni pagos de extremo a extremo.
