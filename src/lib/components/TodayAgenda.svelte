...
<style>.agenda{margin-bottom:28px;border-top:1px solid var(--color-border,#283246);border-bottom:1px solid var(--color-border,#283246);padding:18px 0}.agenda-head{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:14px}h2{font-size:17px;margin:0}button{font-size:12px;color:var(--color-text-muted,#94a3b8);background:none;border:1px solid var(--color-border,#283246);border-radius:8px;padding:7px 12px;cursor:pointer}.agenda-items{display:grid;grid-template-columns:1fr 1fr;gap:20px}a{display:grid;grid-template-columns:auto 1fr auto;gap:6px 18px;text-decoration:none;color:inherit}a>span{font-size:13px;color:var(--color-text-muted,#94a3b8)}small{grid-column:1/3;color:var(--color-text-muted,#94a3b8);font-size:11px}b{grid-column:3;grid-row:1/3;align-self:center;color:#a9d886}p{font-size:13px;color:var(--color-text-muted,#94a3b8)}@media(max-width:650px){.agenda-items{grid-template-columns:1fr;gap:22px}}</style>
