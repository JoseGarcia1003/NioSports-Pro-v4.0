...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/api" | "/api/cron" | "/api/cron/fetch-games" | "/api/cron/fetch-odds" | "/api/cron/verify-results" | "/api/predict-batch" | "/api/predict" | "/api/stripe" | "/api/stripe/checkout" | "/api/stripe/portal" | "/api/stripe/webhooks" | "/bankroll" | "/legal" | "/legal/privacy" | "/legal/responsible-gambling" | "/legal/terms" | "/login" | "/methodology" | "/picks" | "/pricing" | "/results" | "/stats" | "/totales" | "/tracking";
		RouteParams(): {
